...
<br>
<p>$\huge{\large{\color{#6580DD}*** 보안정책 변경 >> 허용되지 않은 IP 접근 차단 (03.25 이후) ***}}$</p>
<br>
<p>$\huge{\large{\color{#DD6565}*** 2차 보안정책 변경 >> 허용되지 않은 IP 접근 차단 (09.16 이후) ***}}$</p>
<p>$\huge{\large{-. 26.09.09부터  09.16까지_     인입_ 협력사 IP 재 취합 기간 (미 취합 IP 차단 예정)}}$</p>
<br>
<br>
<br>
...
** 공지사항 (가이드)
  ...
  [Ver 3.3] (변경날짜 2026-08-12)
  - 상품등록/수정 API의 상품이미지 중 PNG 파일은 자동 JPG 전환 기능 적용
  ...
  [Ver 2.9] (변경날짜 2026-03-25)
  - 배송 > 배송지연요청 API 신설

  [Ver 2.8] (변경날짜 2025-12-10)
  - 상품 등록/수정 API 항목 추가 (수도권 배송비 항목)
